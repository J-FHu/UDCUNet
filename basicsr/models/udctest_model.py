            ...
            if save_img :
                if self.opt['is_train']:
                    ...
                    if self.opt['val']['suffix']:
                        ...
                        save_npy_path = osp.join(save_img_path.split('visualization')[0] + 'npy/' + dataset_name +
                                                 '/' + f'{img_name}.npy')

                imwrite(sr_img, save_img_path)
                if os.path.exists(save_npy_path.split(dataset_name)[0] + dataset_name + '/'):
                    pass
                else:
                    os.makedirs(save_npy_path.split(dataset_name)[0] + dataset_name + '/')
